...
TCL_CC='aarch64-linux-android-clang'
...
TCL_EXTRA_CFLAGS=' -Oz -DBIONIC_IOCTL_NO_SIGNEDNESS_OVERLOAD -pipe -I/system/include'
...
TCL_LD_FLAGS='-L/system/lib64 -Wl,-rpath=/system/lib64 -Wl,--enable-new-dtags -Wl,--export-dynamic '
...
TCL_RANLIB='aarch64-linux-android-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/.termux-build/tcl/build -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/system/lib64 -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/system/include'
...
# compiled.
TCL_SRC_DIR='/root/.termux-build/tcl/src'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/system/lib64 /system/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/.termux-build/tcl/build -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/system/lib64 -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/root/.termux-build/tcl/build/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/system/lib64/libtclstub8.6.a'
