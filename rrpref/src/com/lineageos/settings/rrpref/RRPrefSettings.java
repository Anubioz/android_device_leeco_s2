/*
 *  RR Extra Settings for Leeco Le2
 *
 */

package com.lineageos.settings.rrpref;
...
public class RRPrefSettings extends PreferenceActivity implements OnPreferenceChangeListener {
    private static final boolean DEBUG = false;
    private static final String TAG = "RRPref";
